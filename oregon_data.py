...
normalized_strip_graph_data_set(age_labels, deaths_by_age, 'Cumulative Deaths by Age')
...
normalized_strip_graph_data_set(age_labels, hosp_by_age, 'Cumulative Hospitalizations by Age')
